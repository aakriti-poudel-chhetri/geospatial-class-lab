...
# check that intersect is opposiste of disjoint
...
aggregating_zones_area_weighted <- st_interpolate_aw(incongruent_2,
                                                      aggregating_zones,
                                                      extensive = TRUE)
# extensive is equal to TRUE for population, sums, counts.
# when data is intensive, use extensive is equal to FALSE (eg: density, rate)
...
us_west <- us_states[us_states$REGION == "West", ] # blank after comma is keep whole columns
