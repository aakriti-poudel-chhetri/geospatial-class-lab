...
# Convert high pixels into polygon shapes then transform into a sf
...
bryce = raster("data/week5data/Bryce_Canyon.tif")
...
```{r}
# Separate lines into roads, paths, trails
