...
world_elevation <- read_stars(here::here("data", "week1data", "worldelevation.tif"))

# country boundaries
world_vector <- read_sf(here("data", "week1data","worldvector.gpkg"))

# major cities
world_cities <- read_sf(here("data", "week1data","worldcities.gpkg"))
```
...
tmap_save(map1, here("week1lab", "tmap-example.png"), device = ragg::agg_png)
