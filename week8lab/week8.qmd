...
filelist <- list.files(here::here("data", "week8data", "landsat-data"), full.names = TRUE)
...
SB_county_south <- st_read(here::here("data", "week8data", "SB_county_south.shp")) %>%
...
training_data <- st_read(here::here( "data", "week8data", "trainingdata.shp")) %>%
